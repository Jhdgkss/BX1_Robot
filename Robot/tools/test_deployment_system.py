...
def valid_snapshot():
    ...
    return {
        ...
        "bx1_os": {
            ...
            "release_tag": qualification.RELEASE_TAG,
...
class ReleaseBuilderTests(unittest.TestCase):
    def test_package_is_side_by_side_hashed_and_excludes_live_service(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(manifest["release_version"], builder.RELEASE_VERSION)
            self.assertEqual(manifest["release_tag"], builder.RELEASE_TAG)
...
class DeploymentIntegrationTests(unittest.TestCase):
    ...
    def test_fresh_install_only_creates_isolated_inactive_disabled_install(self):
        ...
        self.assertEqual(installed_manifest["release_version"], builder.RELEASE_VERSION)
        self.assertEqual(
