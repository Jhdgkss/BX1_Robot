...
def rpc_call(method: str, args=None, timeout=6.0):
    if args is None:
        args = []
...
try:
    print()
    print("Testing compact v10.39 non-destructive hardware RPC...")
    ...
    rpc_call("bx1_config_servo_quiet", [1, 1200, 4])
    ...
    print()
    print("WARNING: Router status works, but v10.39 compact hardware/gimbal config failed:", exc)
    raise SystemExit(2)


print()
print("RESULT: PASS - Router RPC can reach the MCU sketch and v10.39 direct head RPC.")
