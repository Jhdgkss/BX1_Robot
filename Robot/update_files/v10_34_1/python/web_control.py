...
function renderSpeech(d){
  ...
  $('voiceMetrics').innerHTML=metric('State',vr.state||'--')+metric('STT ready',yes(v.stt_ready),v.stt_error||'')+metric('Capture',v.capture_method||'alsa')+metric('Endpointing',v.endpointing_enabled?'natural':'fixed');
...
class WebControlServer:
    ...
    def start(self) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "RobotBodyClient/10.34.1"
