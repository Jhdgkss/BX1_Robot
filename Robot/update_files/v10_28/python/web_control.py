...
<title>BX1 Robot Control 10.28</title>
<style>
:root{
...
<div class="app">
<aside class="sidebar">
  <div class="logo"><div class="eyebrow">BX1 / LEO</div><h1>ROBOT<br>CONTROL</h1><small>Robot client v10.28</small></div>
...
<section class="page" id="page-conversation">
  ...
  <div class="grid">
    ...
    <article class="card span-4"><h4>Conversation State</h4><div id="conversationMetrics" class="metric-grid"></div><div class="rule"></div><div id="conversationStatus" class="result-box">Waiting for status…</div><div class="buttons"><button onclick="go('speech')">Wake and microphone settings</button><button onclick="go('hardware')">Servo and LED settings</button></div></article>
  </div>
</section>
...
class WebControlServer:
    ...
    def start(self) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "RobotBodyClient/10.28"
