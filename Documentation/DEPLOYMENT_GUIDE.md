# BX1 OS Alpha v0.3.0 Side-by-Side Deployment Guide
...
v0.3.0 uses the release basename
`bx1-os-alpha-20260728_v0_3_0`. From the repository root:

```bash
scp Deployment/bx1-os-alpha-20260728_v0_3_0.tar.gz \
  Deployment/bx1-os-alpha-20260728_v0_3_0.tar.gz.sha256 \
...
```bash
cd /home/arduino
sha256sum -c bx1-os-alpha-20260728_v0_3_0.tar.gz.sha256
BX1_STAGE="$(mktemp -d /home/arduino/bx1-os-alpha-v0.3.0-staging.XXXXXX)"
tar -xzf bx1-os-alpha-20260728_v0_3_0.tar.gz \
  -C "$BX1_STAGE"
cd "$BX1_STAGE/bx1-os-alpha-20260728_v0_3_0"
```
