...
<title>BX1 Robot Control 10.40</title>
<style>
:root{
...
<div class="app">
<aside class="sidebar">
  <div class="logo"><div class="eyebrow">BX1 / LEO</div><h1>ROBOT<br>CONTROL</h1><small>Robot client v10.40</small></div>
...
class WebControlServer:
    ...
    def start(self) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "RobotBodyClient/10.40"
