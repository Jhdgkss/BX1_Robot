# Robot Brain V2.11.0 — Personality Projects and Voice Binding

- Added a separate PyQt Personality Studio.
- Added portable `.bxpersonality` import/export packages.
- Added personality-owned robot name, GUI theme and voice delivery settings.
- Added per-personality Dot.TTS Voice Lab namespaces and reference migration.
- Embedded the selected Voice Lab profile and accessible voice assets in exported projects.
- Kept hardware, memory, documents, network and safety settings outside personality projects.
